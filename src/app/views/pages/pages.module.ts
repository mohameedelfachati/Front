...
import { AbattoirModule } from './abattoir/abattoir.module';
...
@NgModule({
	...
	declarations: [SubheaderSearchComponent, MycurrencyPipe, DirhamsCurrencyPipe, CustomPaginationComponent, SpinnerViewComponent]
})
