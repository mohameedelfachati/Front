...
export class AssociationService {
	...
	getNbrAssociationByParams(type:any[],commune:any[]): Observable<any[]> {
		return this.http.get<any[]>(this.apiURL + '/association/stats/' + type +'&'+ commune);
	}
	...
	// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	 ...
	 getMondatBureauBetweenDates(d1, d2): Observable<any> {
		return this.http.get<any>(
			this.apiURL + "/mandatBureau/date/" + d1 + "&" + d2
		);
	}
}
